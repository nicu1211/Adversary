...
function shortenMiddle(name, maxLength = 11) {
...
function TargetName({ name, side }) {
  return (
    <span
      title={name}
      className={`block w-full overflow-hidden whitespace-nowrap text-sm font-black leading-none text-white ${
                        ...
                        {row.favourite && (
                          <>
                            ...
                            <div className="relative h-full w-full overflow-hidden rounded-l-md">
                              <div
                                className={`absolute right-0 top-0 flex h-full items-center justify-end overflow-hidden rounded-l-md bg-gradient-to-l ${blueShade} px-2 shadow-[0_0_14px_rgba(59,130,246,.18)]`}
                                style={{
                        ...
                        {row.nemesis && (
                          <>
                            <div className="relative h-full w-full overflow-hidden rounded-r-md">
                              <div
                                className={`absolute left-0 top-0 flex h-full items-center overflow-hidden rounded-r-md bg-gradient-to-r ${redShade} px-2 shadow-[0_0_14px_rgba(244,63,94,.18)]`}
                                style={{
