                        ...
                        {row.favourite && (
                          <>
                            ...
                            <div className="relative h-full w-full overflow-hidden rounded-l-md">
                              ...
                              <div className="absolute inset-y-0 left-0 right-0 flex min-w-0 items-center justify-end px-3">
                                <TargetPlayerName
                        ...
                        {row.nemesis && (
                          <>
                            <div className="relative h-full w-full overflow-hidden rounded-r-md">
                              ...
                              <div className="absolute inset-y-0 left-0 right-0 flex min-w-0 items-center px-3">
                                <TargetPlayerName
